...
% \section{Previous Studies on AGV Mechanical Design}
...
mechanical design.
\newpage
\section{Physical Design Constraints} %realistic constrait
...
% \section{Economic Constraints} %no usefull content
...
% \section{Integration Constraints} % no usefull content
...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|c|c|c|c|}
      \hline \rowcolor{red!20}
      $\alpha$ (degrees) & Height (m) & Mechanical Advantage & Input Force (kN) & Output Force (kN) \\ \hline
...
% \begin{figure}
% \centering
% \includegraphics[width=2.34722in,height=1.27344in]{img/image9.png}
% \caption{\textbf{Figure 8}:hinge (pin support)}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=2.64583in,height=1.76389in]{img/image10.png}
% \caption{\textbf{Figure 9}:actuator cylinder}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=3.52778in,height=2.30556in]{img/image11.jpeg}
% \caption{\textbf{Figure 10}:single level scissor lift}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=3.38657in,height=1.84722in]{img/image12.jpeg}
% \caption{\textbf{Figure 11}:single level scissor lift}
% \end{figure}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.1804}}
%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.8196}}@{}}
% \caption{\textbf{Table 11}: Key components of the scissor lift mechanism
% and their functional descriptions}\tabularnewline
% \toprule\noalign{}
...
% \includegraphics[width=0.83278in,height=0.44444in]{img/image13.jpeg} &
% Main structural members forming the \textquotesingle X\textquotesingle{}
% pattern, typically made of steel or aluminum for strength and
% durability \\
% Hinge

% \includegraphics[width=0.85262in,height=0.45139in]{img/image14.jpeg} &
% Mechanical components that provide rotational freedom while restricting
% translational movement at joint connections \\
% Platform

% \includegraphics[width=0.79167in,height=0.42081in]{img/image15.jpeg} &
% Upper surface designed to support the load, including reinforcement
% structures and safety rails \\
% Linear Actuator

% \includegraphics[width=0.80821in,height=0.40972in]{img/image16.jpeg} &
% Electric motor-driven mechanism that provides the force for lifting and
% lowering operations \\
% Bushing

% \includegraphics[width=0.83333in,height=0.59701in]{img/image17.jpeg} &
% Plain bearings that provide smooth sliding motion and wear resistance at
% pivot points \\
% Bearing

% \includegraphics[width=0.83333in,height=0.54146in]{img/image18.jpeg} &
% Rolling elements that reduce friction between moving parts and support
% radial and axial loads \\
% Shaft

% \includegraphics[width=0.82639in,height=0.4375in]{img/image19.jpeg} &
% Cylindrical components that transfer rotational motion and support
% rotating elements in the mechanism \\
% Fasteners

% \includegraphics[width=1.07562in,height=0.56944in]{img/image20.jpeg}

% \includegraphics[width=0.86574in,height=0.45833in]{img/image21.jpeg} &
% Bolts, nuts, and pins used to secure components and allow for
% maintenance \\
% \end{longtable}
...
% \begin{figure}
% \centering
% \includegraphics[width=4.55556in,height=2.46049in]{media/image22.jpeg}
% \caption{\textbf{Figure 12}:Result for the stress analysis}
% \end{figure}
...
% \begin{figure}
% \centering
% \includegraphics[width=3.875in,height=2.58195in]{media/image23.jpeg}
% \caption{\textbf{Figure 13}:result for displacement analysis}
% \end{figure}
...
% \begin{figure}
% \centering
% \includegraphics[width=3.71032in,height=2.47222in]{media/image24.jpeg}
% \caption{\textbf{Figure 14}:results for static strain analysis}
% \end{figure}
...
% \begin{figure}
% \centering
% \includegraphics[width=2.85417in,height=3.18306in]{media/image25.jpeg}
% \caption{Figure 15: AGV chassis structure}
% \end{figure}
...
% \begin{figure}
% \centering
% \includegraphics[width=4.40972in,height=2.39583in]{media/image26.jpeg}
% \caption{Figure 16: 3D model of protective frame and covering}
% \end{figure}
...
% \begin{figure}
% \centering
% \includegraphics[width=2.91667in,height=2.2931in]{media/image27.png}
% \caption{Figure 17: 2D profile of aluminum extrusion}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=3.00694in,height=2.25371in]{media/image28.png}
% \caption{Figure 18: 2D model of profile joint and fasteners}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=3.69444in,height=1.95324in]{media/image29.png}
% \caption{Figure 19: 2D model of Chassis and frame}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=3.94444in,height=2.69018in]{media/image30.jpeg}
% \caption{Figure 20: 3D design of chassis and frame covering}
% \end{figure}
...
% \begin{figure}
% \centering
% \includegraphics[width=4.58498in,height=2.53472in]{media/image31.jpeg}
% \caption{Figure 21: Load distribution on the chassis}
% \end{figure}
...
\chapter{\texorpdfstring{\textbf{CONCLUSION AND FUTURE
...
% \item
%   EUGENIU ZAINESCU: \emph{CALCULATION OF SINGLE LEVEL SCISSOR LIFT,
%   2019.}
% \item
%   TIMKEN: \emph{DEEP GROOVE BALL BEARING CATALOG.}
% \item
%   R. C. Hibbeler: \emph{Engineering Mechanics Statics and Dynamics
%   Fourteenth edition, 2016.}
% \item
%   MCLE 476 LECTURES: \emph{INTRODUCTION MECHANISMS AND KINEMATICS}
% \item
%   Eagle: \emph{aluminum catalogs-}
% \item
%   P. D. Smith and J. R. Wilson: \emph{"Design and Analysis of Automated
%   Guided Vehicles,"} Journal of Industrial Engineering, vol. 45, no. 3,
%   pp. 156-172, 2024.
% \item
%   R. Kumar: \emph{"Structural Analysis Using SolidWorks Simulation,"}
%   Mechanical Design Engineering Handbook, 2nd ed. Academic Press, 2024.
% \item
%   M. Thompson: \emph{"Advanced Scissor Lift Mechanisms: Design and
%   Implementation,"} International Journal of Mechanical Engineering,
%   vol. 12, no. 4, pp. 78-92, 2023.
% \item
%   H. Chen and L. Zhang: \emph{"Load Analysis in AGV Chassis Design,"}
%   Robotics and Automation Systems, vol. 33, pp. 245-260, 2024.
% \item
%   B. Anderson: \emph{"Material Selection for Industrial AGV
%   Applications,"} Materials Today: Proceedings, vol. 28, pp. 1123-1135,
%   2024.
% \item
%   K. Roberts: \emph{"Safety Standards in Automated Material Handling
%   Systems,"} Industrial Safety Guidelines, 5th ed. Springer, 2023.
% \item
%   D. Williams and S. Brown: \emph{"Stress Analysis Techniques in
%   Manufacturing Design,"} Manufacturing Technology Today, vol. 15, no.
%   2, pp. 112-128, 2024.
% \item
%   T. Johnson: \emph{"Modern AGV Systems: Design Principles and
%   Applications,"} Automation Engineering Review, vol. 8, no. 1, pp.
%   45-62, 2024.
% \end{enumerate}
\end{document}