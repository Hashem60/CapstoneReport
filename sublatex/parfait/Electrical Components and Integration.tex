...
\chapter{Electrical System Design}
...
higher than the battery's output. To address this, boost converters(Figure~\ref{Stepper motors booster} and Figure~\ref{Linear actuator booster}) are 
...
The HX711 in Figure~\ref{ HX711 Load cell amplifier } is specifically designed to enhance the weak 
output signals from the load cellin Figure~\ref{ Load cell }, ensuring accurate and reliable weight measurements.
...
In this design, the \textbf{Raspberry Pi 4} shown in Figure~\ref{ Raspberry Pi 4} serves as the primary 
...
Complementing the Raspberry Pi, the \textbf{ESP32 microcontroller} in Figure~\ref{ ESP32-S3-DevKitC-1} 
