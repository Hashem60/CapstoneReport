...
\begin{codebox}[]{Applies a stainless steel texture to the platform’s surface.}
  \begin{minted}{xml}
        ... 
...
\end{codebox}
\newpage
\begin{codebox}[]{Constructs the front legs.}
...
\newpage
\begin{codebox}[]{Assigns materials to different intersection areas in the environment.}  
  \begin{minted}{cpp}
...
{
